          ...
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12 col-md-7">
              ...
              <q-banner class="bg-grey-2" rounded dense>
                <code>mock-me --manual hub create --config data/mockups/{{ id }}/out/hub.yaml --skip-wait --skip-acm</code>
              </q-banner>
            </div>
          </div>
          <q-stepper-navigation>
        ...
        <q-step :name="2" title="Install ACM" icon="extension" :done="step > 2">
          ...
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12 col-md-6">
              ...
              <q-banner class="bg-grey-2" rounded dense>
                <code>mock-me hub install-acm --config data/mockups/{{ id }}/out/hub.yaml</code>
              </q-banner>
            </div>
          </div>
          <q-stepper-navigation>
              ...
              <q-card flat bordered class="cluster-card full-height">
                ...
                <q-card-section class="q-pt-none">
                  ...
                  <q-banner dense rounded class="bg-grey-2 text-caption">
                    <code>mock-me --manual cluster create --config …/out/cluster-{{ c.name }}.yaml</code>
                  </q-banner>
                </q-card-section>
              ...
              <q-card flat bordered>
                <q-card-section>
                  ...
                  <q-banner dense rounded class="bg-grey-2 q-mt-sm text-caption">
                    <code>mock-me cluster attach-iso --config …/cluster-{{ c.name }}.yaml --iso {{ c.discoveryISO || `./discovery-${c.name}.iso` }}</code>
                  </q-banner>
                </q-card-section>
              </q-card>
            </div>
